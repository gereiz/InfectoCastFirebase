...
class PlanoContratadoWidget extends StatefulWidget {
  const PlanoContratadoWidget({super.key});

  @override
  State<PlanoContratadoWidget> createState() => _PlanoContratadoWidgetState();
}

class _PlanoContratadoWidgetState extends State<PlanoContratadoWidget>
    with TickerProviderStateMixin {
  late PlanoContratadoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlanoContratadoModel());
