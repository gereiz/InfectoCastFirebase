...
import 'lista_videos_model.dart';
export 'lista_videos_model.dart';

class ListaVideosWidget extends StatefulWidget {
...
class _ListaVideosWidgetState extends State<ListaVideosWidget>
    with TickerProviderStateMixin {
  late ListaVideosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListaVideosModel());
